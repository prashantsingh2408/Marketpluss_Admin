...
!(function (a) {
  ...
  a.fn[b] = function (b) {
            ...
            if ("object" == typeof d.childrens && d.childrens.length) {
              ...
              !b.addControlOnParent ||
                ...
                f.append(
                  a('<span class="node"/> ')
                    .addClass(
                      b.collapsable ? (b.collapsed ? "open" : "closed") : ""
                    )
                    .append(a("<label/>").append(d.label).attr("class", "node"))
                );
              var g = a("<ul/>");
              b.ul.append(f),
                f.append(g),
                    ...
                    .append(
                      "undefined" != typeof b.type
                        ? a("<input/>")
                            ...
                            .attr(
                              "name",
                              "checkbox" === b.type ? d.name || b.name : b.name
                            )
                            .attr("value", d.value)
                            .attr("class", "leaf")
                            .attr("id", d.id)
    ...
    if (
      (b.collapsable &&
        a("li span.node", d).on("click", function (b) {
      ...
      var f = function () {
        ...
        if (b.length) {
          ...
          a(this)
            ...
            .each(function () {
              (a(this).prop("checked") &&
                !0 !== a(this).prop("indeterminate")) ||
                (c = !1),
                (a(this).prop("checked") ||
                  !0 === a(this).prop("indeterminate")) &&
                  (d = !0);
            }),
            d || !0 === a(this).prop("indeterminate")
              ? b.addClass("indeterminate").prop("indeterminate", !0)
              : b.removeClass("indeterminate").prop("indeterminate", !1),
            c &&
              b
                .prop("checked", !0)
                .prop("indeterminate", !1)
