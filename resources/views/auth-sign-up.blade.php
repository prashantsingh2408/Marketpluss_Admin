...
<body class=" ">
  ...
  <div class="wrapper">
    <section class="login-content"><div class="container h-100">
        ...
        <div class="card-body">
          ...
          <form>
                ...
                <div class="form-check form-check-inline">
                  <div class="custom-control custom-checkbox custom-control-inline mb-3">
                    ...
                    <label class="custom-control-label pl-2" for="inlineCheckbox1">I
                      agree to the <a href="terms-of-service">Terms of Service
                      </a> and <a href="privacy-policy">Privacy
                        Policy</a></label>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 mt-3">
              <p class="mb-0 text-center">Do you have an account? <a href="{{url('auth-login')}}">Sign In</a></p>
            </div>
          </form>
        </div>
      </div>
