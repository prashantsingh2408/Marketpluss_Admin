...
<!-- Mirrored from templates.iqonic.design/datum/html/backend/chart-apex by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Aug 2021 05:51:01 GMT -->
          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="side-menu">
                      ...
                      <li class=" sidebar-layout">
                          <a href="customer" class="svg-icon ">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class=" sidebar-layout">
                          <a href="https://templates.iqonic.design/datum/html/app/todo" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class=" sidebar-layout">
                          <a href="https://templates.iqonic.design/datum/html/app/calendar" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class=" sidebar-layout">
                          <a href="https://templates.iqonic.design/datum/html/app/chat" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                       ...
                       <li class=" sidebar-layout">
                          <a href="https://templates.iqonic.design/datum/html/app/user-profile" class="svg-icon">
                              <i class="">
                      ...
                      <li class="sidebar-layout">
                          ...
                          <ul id="app1" class="submenu collapse" data-parent="#iq-sidebar-toggle">                        
                              <li class=" sidebar-layout">
                                  <a href="auth-login" class="svg-icon">
                              ...
                              <li class=" sidebar-layout">
                                  <a href="auth-recover-pwd" class="svg-icon">
                                      <i class="">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class=" sidebar-layout">
                          <a href="pages-comingsoon" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class=" sidebar-layout">
                          <a href="pages-faq" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class=" sidebar-layout">
                       ...
                       <li class=" sidebar-layout">
                          <a href="timeline" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          ...
                          <ul id="app3" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="sidebar-layout">
                                  ...
                                  <ul id="form1" class="submenu collapse" data-parent="#app3">
                                      <li class=" sidebar-layout">
                                          <a href="form-layout" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-input-group" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">   
                                          <a href="form-validation" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-switch" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-chechbox" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-radio" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                  </svg>
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-textarea" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              ...
                              <li class="sidebar-layout">
                                  ...
                                  <ul id="form2" class="submenu collapse" data-parent="#app3">
                                      <li class=" sidebar-layout">
                                          <a href="form-datepicker" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                  </svg>
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-select" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-file-uploader" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                      ...
                                      <li class=" sidebar-layout">
                                          <a href="form-quill" class="svg-icon">
                                              <i class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                  </svg>
                      ...
                      <li class="sidebar-layout">
                          ...
                          <ul id="app5" class="submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class=" sidebar-layout">
                                  <a href="tables-basic" class="svg-icon">
                                      <i class="">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              ...
                              <li class=" sidebar-layout">
                                  <a href="table-data" class="svg-icon">
                                      <i class="">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              ...
                              <li class=" sidebar-layout">
                                  <a href="table-editable" class="svg-icon">
                                      <i class="">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <li class="active sidebar-layout">
                          <a href="chart-apex" class="svg-icon">
                              <i class="">
                      ...
                      <li class=" sidebar-layout">
                          <a href="icon-heroicon" class="svg-icon">
                              <i class="">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              ...
                              <li class="nav-item nav-icon dropdown">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                      <li class="dropdown-item d-flex svg-icon">
                                          ...
                                          <a href="https://templates.iqonic.design/datum/html/app/user-profile">My Profile</a>
                                      </li>
                                      <li class="dropdown-item d-flex svg-icon">
                                          ...
                                          <a href="https://templates.iqonic.design/datum/html/app/user-profile-edit">Edit Profile</a>
                                      </li>
                                      <li class="dropdown-item d-flex svg-icon">
                                          ...
                                          <a href="https://templates.iqonic.design/datum/html/app/user-account-setting">Account Settings</a>
                                      </li>
                                      <li class="dropdown-item d-flex svg-icon">
                                          ...
                                          <a href="https://templates.iqonic.design/datum/html/app/user-privacy-setting">Privacy Settings</a>
                                      </li>
