...
<!--
                <li class="dropdown-item d-flex svg-icon">
                  ...
                  <a href="https://templates.iqonic.design/datum/html/app/user-profile-edit.html">Edit
                    Profile</a>
                </li>
-->
<!--
                <li class="dropdown-item d-flex svg-icon">
                  ...
                  <a href="https://templates.iqonic.design/datum/html/app/user-account-setting.html">Account
                    Settings</a>
                </li>
-->
                <!--
                <li class="dropdown-item d-flex svg-icon">
                  ...
                  <a href="https://templates.iqonic.design/datum/html/app/user-privacy-setting.html">Privacy
                    Settings</a>
                </li>
-->
